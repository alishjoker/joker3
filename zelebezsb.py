# -*- coding: utf-8 -*-
print("EpWy95IEOwAUgwQuThc9.I5F+Bwgq2M8Nsf2ve6nt6q.T/aBH4YLCKfSnAHxBuip4bmWm3347Vy++ibOZ9MvKaU=")
print("http://101.255.95.249:6969")
print("FIXED BY RIO")
print("add my id line: http://line.me/ti/p/~joker.alish")
print("Alish Joker ") 
...
cl = LIBERATION.LINE()
cl.login(token='EpWy95IEOwAUgwQuThc9.I5F+Bwgq2M8Nsf2ve6nt6q.T/aBH4YLCKfSnAHxBuip4bmWm3347Vy++ibOZ9MvKaU=')
cl.loginResult()
...
#==============================================================================# 
        if op.type == 5:
            if settings["autoAdd"] == True: 
                ...
                cl.sendText(op.param1, "سلام " + xname + "خوش اومدی ,")
        if op.type == 13:
            if mid in op.param3:
